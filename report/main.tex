...
protocol specification in appendix XX\todo{Add RFC as appendix}).
...
changes in the codebase are required to make the game truly multiplayer.\todo{et
être le prochain craquage de blocus de l'UCL}

\appendix

\section{Network specification}
\todo[inline]{A ajouter}
