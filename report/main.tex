...
library. The user can then take a picture of himself, indicates which player he is
and upload the picture on the Raspberry-Pi at a pre-defined location. At the start
of each new game, the game server picks the two last uploaded images and sends it
