...
\begin{frame}{SPI state machine}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{img/spi_state_machine_cropped}
    \end{center}
...
\begin{frame}{Pipeline}
    \begin{center}
        \includegraphics[width=0.8\textwidth]{img/block_pictures_cropped}
    \end{center}
\end{frame}
